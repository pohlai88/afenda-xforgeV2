...
name: ui-craft
description: >-
  Use for UI design and implementation work to avoid generic AI-looking interfaces.
  Provides anti-slop rules, discovery before coding, and guidance for layout, typography,
  color, motion, accessibility, dashboards, landing pages, theming, and polish. Trigger
  when editing UI code or refining components, pages, screens, layouts, or design systems.
