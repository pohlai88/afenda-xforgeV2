  ...
  return (
    <main
      ...
      className={cn(
        ...
        "md:peer-data-[variant=inset]:m-2 md:peer-data-[variant=inset]:ml-0 md:peer-data-[variant=inset]:rounded-[var(--card-radius)] md:peer-data-[variant=inset]:shadow-panel md:peer-data-[variant=inset]:peer-data-[state=collapsed]:ml-2",
        recipe("motionReduce"),
        className
      )}
      {...props}
...
function SidebarHeader({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="header"
      className={cn("flex flex-col gap-2 p-2", recipe("motionReduce"), className)}
      {...props}
    />
  )
}
...
function SidebarGroup({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      data-sidebar="group"
      className={cn("relative flex w-full min-w-0 flex-col p-2", recipe("motionReduce"), className)}
      {...props}
    />
  )
}
  ...
  return (
    <Comp
      ...
      className={cn(
        ...
        recipe("metadataText", "focusRingOnly", "mutedControlIcon", "motionReduce"),
        className
      )}
      {...props}
    />
...
function SidebarGroupAction({
  ...
  return (
    <Comp
      ...
      className={cn(
        "absolute right-3 top-3.5 flex aspect-square w-5 items-center justify-center rounded-[var(--xforge-radius-sm)] p-0 text-text-secondary outline-none hover:bg-surface-hover hover:text-text-primary group-data-[collapsible=icon]:hidden after:absolute after:-inset-2 md:after:hidden",
        recipe("colorTransition", "focusRingOnly", "mutedControlIcon", "motionReduce"),
        className
      )}
      {...props}
    />
...
function SidebarMenu({ className, ...props }: React.ComponentProps<"ul">) {
  return (
    <ul
      ...
      data-sidebar="menu"
      className={cn("flex w-full min-w-0 flex-col gap-1", recipe("motionReduce"), className)}
      {...props}
    />
  )
}
...
function SidebarMenuItem({ className, ...props }: React.ComponentProps<"li">) {
  return (
    <li
      ...
      className={cn("group/menu-item relative", recipe("motionReduce"), className)}
      {...props}
    />
  )
}
...
function SidebarMenuAction({
  ...
  return (
    <Comp
      ...
      type={asChild ? undefined : (type ?? "button")}
      className={cn(
        "absolute right-1 top-1.5 flex aspect-square w-5 items-center justify-center rounded-[var(--xforge-radius-sm)] p-0 text-text-secondary outline-none hover:bg-surface-hover hover:text-text-primary peer-hover/menu-button:text-text-primary group-data-[collapsible=icon]:hidden after:absolute after:-inset-2 md:after:hidden",
...
function SidebarMenuBadge({
  ...
  return (
    <div
      ...
      className={cn(
        "pointer-events-none absolute right-1 flex h-5 min-w-5 select-none items-center justify-center rounded-[var(--xforge-radius-sm)] px-1 text-text-secondary peer-hover/menu-button:text-text-primary peer-data-[active=true]/menu-button:text-text-primary peer-data-[size=sm]/menu-button:top-1 peer-data-[size=default]/menu-button:top-1.5 peer-data-[size=lg]/menu-button:top-2.5 group-data-[collapsible=icon]:hidden",
        recipe("badgeText"),
        className
      )}
      {...props}
...
function SidebarMenuSkeleton({
  ...
  return (
    <div
      ...
      className={cn("flex h-8 items-center gap-2 rounded-[var(--xforge-radius-sm)] px-2", recipe("motionReduce"), className)}
      {...props}
    >
      {showIcon && (
        <Skeleton
...
function SidebarMenuSubItem({
  ...
  return (
    <li
      ...
      className={cn("group/menu-sub-item relative", recipe("motionReduce"), className)}
      {...props}
    />
  )
}
...
function SidebarMenuSubButton({
  ...
  return (
    <Comp
      ...
      data-active={isActive}
      className={cn(
        "flex h-7 min-w-0 -translate-x-px items-center gap-2 overflow-hidden rounded-[var(--xforge-radius-sm)] px-2 text-text-secondary outline-none hover:bg-surface-hover hover:text-text-primary active:bg-surface-active active:text-text-primary data-[active=true]:bg-surface-active data-[active=true]:text-text-primary disabled:pointer-events-none disabled:opacity-50 aria-disabled:pointer-events-none aria-disabled:opacity-50 group-data-[collapsible=icon]:hidden [&>span:last-child]:truncate",
        size === "sm" && "text-[12px]",
        size === "md" && "text-[13px]",
        recipe("colorTransition", "focusRingOnly", "mutedControlIcon", "motionReduce"),
        className
