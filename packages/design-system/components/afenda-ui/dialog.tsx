  ...
  return (
    <DialogPortal {...portalProps}>
      ...
      <DialogPrimitive.Content
        className={cn(
          "data-[state=closed]:fade-out-0 data-[state=closed]:zoom-out-95 data-[state=open]:fade-in-0 data-[state=open]:zoom-in-95 fixed top-[50%] left-[50%] z-[var(--xforge-z-modal)] grid w-[calc(100%-2rem)] max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] outline-none data-[state=closed]:animate-out data-[state=open]:animate-in motion-reduce:animate-none sm:max-w-lg",
