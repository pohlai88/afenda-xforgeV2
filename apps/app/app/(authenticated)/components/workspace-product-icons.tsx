...
type WorkspaceProductIconProps = ComponentPropsWithoutRef<"svg">;

function WorkspaceProductIconBase({
  children,
  className,
  ...props
}: WorkspaceProductIconProps) {
  return (
    <svg
      aria-hidden="true"
      className={className}
...
export function OrbitCaseIcon(props: WorkspaceProductIconProps) {
  return (
    <WorkspaceProductIconBase {...props}>
    ...
    </WorkspaceProductIconBase>
  );
}

export function NexusNetIcon(props: WorkspaceProductIconProps) {
  return (
    <WorkspaceProductIconBase {...props}>
...
export function ArcanaVaultIcon(props: WorkspaceProductIconProps) {
  return (
    <WorkspaceProductIconBase {...props}>
...
export function CodexDriveIcon(props: WorkspaceProductIconProps) {
  return (
    <WorkspaceProductIconBase {...props}>
