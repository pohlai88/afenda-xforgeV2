...
> = {
  ...
  badge: {
    ...
    recipes: ["captionText", "colorTransition"],
    states: ["default"],
    examples: [],
  },
  card: {
    ...
    variants: [],
    recipes: ["sectionGap", "titleText", "captionText", "modalSurface"],
    states: ["default"],
    examples: [],
  },
  form: {
    ...
    variants: [],
    recipes: ["captionText", "invalidState"],
  ...
  tabs: {
    slots: ["tabs", "tabs-list", "tabs-trigger", "tabs-content"],
    variants: [],
    recipes: ["bodyText", "colorTransition", "focusRingOnly", "motionReduce"],
    states: ["default", "selected"],
    examples: [],
  },
  AppSidebar: {
  ...
  AfendaAppSidebar: {
    ...
    variants: [],
    recipes: ["blockShell", "blockMetricLabel"],
    states: ["default", "selected"],
    examples: [],
  },
  AfendaAppTopbar: {
    ...
    variants: [],
    recipes: ["blockShell", "blockToolbar", "blockMetric", "blockMetricLabel"],
    states: ["default", "open"],
    examples: [],
  },
  AfendaAppContent: {
  ...
  AfendaAppFooter: {
    slots: ["app-footer", "app-footer-link", "app-footer-links"],
    variants: [],
    recipes: ["blockShell"],
    states: ["default"],
    examples: [],
  ...
  ChartAreaInteractive: {
    slots: ["chart-area-interactive"],
    variants: [],
    recipes: ["blockPanel", "blockHeader", "blockTitle", "blockDescription"],
    states: ["default"],
    examples: [],
  },
  DashboardDataTable: {
    slots: ["dashboard-data-table"],
    variants: [],
    recipes: ["blockShell", "blockPanel", "blockToolbar"],
    states: ["default", "loading", "empty"],
    examples: [],
  },
  DashboardNavTopbar: {
    slots: ["dashboard-nav-topbar"],
    variants: [],
    recipes: ["blockChrome", "blockTitle", "blockToolbar"],
    states: ["default"],
    examples: [],
  },
  DashboardPage: {
    slots: ["dashboard-page"],
    variants: [],
    recipes: ["blockStage", "blockStack", "blockShell"],
    states: ["default"],
    examples: [],
  },
  NavDocuments: {
    slots: ["nav-documents", "nav-documents-more"],
    variants: [],
    recipes: ["blockMetricLabel"],
    states: ["default"],
    examples: [],
  },
  NavMain: {
    slots: ["nav-main", "nav-main-items"],
    variants: [],
    recipes: ["blockMetricLabel"],
    states: ["default", "selected"],
    examples: [],
  ...
  SectionCards: {
    slots: ["section-cards"],
    variants: [],
    recipes: ["blockShell", "blockMetric", "blockMetricLabel"],
    states: ["default"],
    examples: [],
  },
  SiteHeader: {
    slots: ["site-header", "dashboard-nav-topbar"],
    variants: [],
    recipes: ["blockChrome", "blockTitle", "blockToolbar"],
    states: ["default"],
    examples: [],
