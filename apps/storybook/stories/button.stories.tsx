...
const meta = {
  ...
  argTypes: {
    ...
    variant: uiButtonVariantArgType,
    size: uiButtonSizeArgType,
  ...
  render: () => (
    <div className="grid gap-5">
      {(
        ...
        <div className="grid grid-cols-5 items-center gap-3" key={variant}>
          <span className="w-24 text-muted-foreground text-sm">{variant}</span>
          <Button variant={variant}>Default</Button>
          <Button className="ring-[3px] ring-ring/50" variant={variant}>
            Focus
          </Button>
