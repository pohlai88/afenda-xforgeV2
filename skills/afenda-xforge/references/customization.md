...
Afenda XForge is designed to be modular. Each integration can be replaced by modifying its corresponding package.
...
```typescript
import { Alert, AlertTitle, AlertDescription } from '@repo/design-system';
```
